...
- **Branding Message** - Added the ability to add a branding message on the login screen
...
- **Settings Bug** - Resolved issue where all of the settings were not being returned in all cases
